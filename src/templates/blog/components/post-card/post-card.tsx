...
export const PostCard = ({ author, date, description, image, slug, title }: PostCardProps) => {
    return (
        <Link href={`/blog/${slug}`} className="w-full max-w-2xl rounded-[12px] border border-gray-400 bg-gray-600 overflow-hidden transition-all duration-300 hover:border
            hover:border-blue-300">
            <div className="p-2 rounded-md overflow-hidden">
                <div className="relative">
                    <div className="absolute top-0 right-0 px-3 py-1 bg-gray-600 backdrop-blur-sm 
                        rounded-bl-[10px]">
