...
export const FeatureSection = () => {
  return (
    <section className="container gb-gray-700 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10">
      ...
      <div className="col-span-full flex flex-col gap-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12 ">
              <div className="flex flex-col gap-4">
                ...
                <Button className="w-fit rounded-full hidden mt-4 md:mt-auto md:flex">
              ...
              <div className="flex flex-col items-center justify-center w-full">
                ...
                <Button className="w-full rounded-full gap-2 mt-4 md:mt-auto md:hidden">
                    <Link href="/criar-loja">
                        Criar loja grátis
                    </Link>
                    <ArrowRight />
