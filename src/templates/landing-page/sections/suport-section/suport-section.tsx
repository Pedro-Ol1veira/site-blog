        ...
        <section className="relative pb-8 md:py-10 bg-gray-700">
            ...
            <div className="container flex flex-col items-center gap-12 relative">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:pd-12 bg-blue-400">
                        ...
                        <strong className="text-heading-sm text-gray-100">Personalize o seu site</strong>
                        <p className="text-body-sm text-gray-200">Adicione sua logo, favicon, cores no seu catalago e tenha tudo com a sua cara.</p>
                    </div>

                    <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:pd-12 bg-cyan-300">
